...
function createShipment(){
    ...
    setTimeout(createShipmentNow, 50)
}
function createShipmentNow(){

    let ns = loadModules();
    let shipObj = {
        "id": ns.runtime.getCurrentUser().id,
        "subsidiary": ns.runtime.getCurrentUser().subsidiary,
        "location": ns.runtime.getCurrentUser().location
    }

    // var suiteletURL = ns.url.resolveScript({
    //     scriptId: "customscript_h5_sl_create_mailroom_ship",
    //     deploymentId: "customdeploy_h5_sl_create_mailroom_ship",
    ...
    var shipRec = ns.https.post({
        url: "https://4973611.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=6260&deploy=1&compid=4973611&ns-at=AAEJ7tMQa3YBCB4OlR646EW02l-ajdRpkWyZdQqXh_ZuOqihBrI",
    ...
    if (JSON.parse(shipRec.body).code == 201) {
        window.open("https://4973611.app.netsuite.com/app/common/custom/custrecordentry.nl?rectype=1977&id=" + JSON.parse(shipRec.body).newShipmentId)
        location.reload();
...
function saveAndShip(){
    ...
    var shipRec = ns.https.post({
        url: "https://4973611.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=6240&deploy=1&compid=4973611&ns-at=AAEJ7tMQymwbxLhC6AaVngKhzBZ8lKZlXTM9dOXyf5O37Rb4qkU",
...
function consolidate(data){
    ...
    let response = ns.https.post({
        url:"https://4973611.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=6242&deploy=1&compid=4973611&ns-at=AAEJ7tMQIhXNw3GCSlRuVGFSriUWKk-C-sFjzu7tcaomk0CxD3M",
        headers: headerObj,
...
function printDocs(shipRecIds){
    ...
    let response = ns.https.post({
        url:"https://4973611.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=6175&deploy=1&compid=4973611&ns-at=AAEJ7tMQYbbV9FKIZ0jBec8T1SlYjd9Zr-P6NT2jWCcfdikyEcA",
        headers: headerObj,
        body: JSON.stringify(shipmentsToSend)
    })
...
function getShipData(shipModelData){
    ...
    let response = ns.https.post({
        url:"https://4973611.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=6239&deploy=1&compid=4973611&ns-at=AAEJ7tMQLBuVeofEKTmwNii-_Qqe76nFttmouaXFmi8vgnioImM",
        headers: headerObj,
        body: shipId
    });
