...
function manifestCarrier(locationId, employeeName){
    console.log("locationId", locationId + " | " + employeeName)

    location.replace("https://4973611.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=7570&deploy=1&compid=4973611&ns-at=AAEJ7tMQ2vmNFXg9ZYGXNEQtiGtmsXQQGR_dSdtKcF-4rxvquBc&locationId=" + locationId + "&employee=" + employeeName)
